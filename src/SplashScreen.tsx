...
const NSplashScreen: React.FC<NSplashScreenProps> = ({
  ...
  duration = 3000,
  onHide,
  logoSrc = 'https://www.npmjs.com/npm-avatar/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdmF0YXJVUkwiOiJodHRwczovL3MuZ3JhdmF0YXIuY29tL2F2YXRhci84ZWNjMjQ2OGY2YjEwYzIxY2EzZmM3Nzk3ZTNhNjQ0Yz9zaXplPTQ5NiZkZWZhdWx0PXJldHJvIn0.Iabsa4eJ0mPKMBFLsCryOVrXxFLG3I5m_HGpboOOpbk',
  logoAlt = 'App Logo',
  logoWidth = 120,
  logoHeight = 120,
